        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              window.setTimeout(function () {
                location.assign("/").reload(true); //location.reload(true); // if success full then req will be with /
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoibWVocmFiYmQiLCJhIjoiY2tyZ3F1b252Mm1keTJ6cDh2M2t0ajFxZiJ9.oWi2CanlL38A4aGZkHawTg";
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    (0, _login.login)(email, password); //console.log(email, password);
  });
}
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              //await waiting to update ..after finish next line execute
